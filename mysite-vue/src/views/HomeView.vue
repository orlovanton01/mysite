            ...
            <div class="col" v-for="course in data">
              <div class="card h-100" style="width: 18rem; ">
                ...
                <div class="card-body">
                  ...
                  <a class="btn btn-outline-info" @click="OpenReview(course)">
                    <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-chat" viewBox="0 0 16 16">
